...
var useDagre = true;
var currentQuery = 'The quick brown fox jumped over the lazy dogffff.';
...
$(document).ready(function() {
  ...
  $('#language').on('change', function() {
      $('#text').attr('placeholder', 'Washington is a state in the U.S.');
  });
  ...
  $('#submit').click(function() {
    ...
    $.ajax({
      type: 'POST',
      url: serverAddress + 'ajax' + '?properties=' + encodeURIComponent(
