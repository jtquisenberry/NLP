...
def get_text_from_row(row):
    guid = row['guid']
    text_start = row['line_position']
    text_length = row['line_length']
...
if __name__ == '__main__':
    ...
    out_directory = r"E:\Corpora\PII_Directory_20190507\export_lines"
    ...
    df.to_pickle(os.path.join(in_directory, 'pickled_lines.pkl'))
    print('DONE')
