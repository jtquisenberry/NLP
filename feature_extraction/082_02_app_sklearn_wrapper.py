...
if __name__ == '__main__':
    ...
    in_pickled_df = os.path.join(in_directory, 'pickled_paragraphs_transformed_001.pkl')
    out_pickled_df = None
    ...
    sklearn_wrapper_extractor.features_csv = os.path.join(in_directory, 'pickled_paragraphs_features_20190611-002.csv')
    sklearn_wrapper_extractor.features_pkl = os.path.join(in_directory, 'pickled_paragraphs_features_20190611-002.pkl')
