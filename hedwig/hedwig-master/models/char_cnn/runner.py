...
class CustomArgs():
    ...
    def __init__(self, batch_size=128, cuda=True, data_dir='..\\hedwig-data\\datasets',
                 dataset='Reuters', dropout=0.5, epoch_decay=15, epochs=50, gpu=0, log_every=10, lr=0.001,
                 num_affine_neurons=1024, num_conv_filters=256, output_channel=256, patience=5,
                 resume_snapshot=None, save_path='model_checkpoints\\char_cnn', seed=3435,
                 trained_model=None, weight_decay=0, word_vectors_dir='..\\hedwig-data\\embeddings\\word2vec',
        ...
        self.word_vectors_dir = word_vectors_dir
